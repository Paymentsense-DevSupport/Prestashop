...
<h3>{$ReturnMessage1|escape:'htmlall':'UTF-8'}</h3>
<br />
<p>{$ReturnMessage2|escape:'htmlall':'UTF-8'}</p>
<br />
<p>{$ReturnMessage3|escape:'htmlall':'UTF-8'}</p>
<br />
<p>{$ReturnMessage4|escape:'htmlall':'UTF-8'}</p>
<br />
<p>{$ReturnMessage5|escape:'htmlall':'UTF-8'}</p>
<br />
